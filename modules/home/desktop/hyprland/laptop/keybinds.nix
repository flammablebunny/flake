...
in
{
  wayland.windowManager.hyprland.settings = {
    ...
    bindl = [
      # Clear notifications - TODO: add IPC for this if needed
      # "${kb.clearNotifs}, exec, quickshell ipc call notifications clear"
    ...
    bindr = [
      ...
      "Ctrl+Super+Alt, R, exec, pkill quickshell; sleep 0.5; qs &"
    ];
