...
PanelWindow {
    ...
    function snip() {
        ...
        // Adjust action - only for Copy mode (right-click opens editor as shortcut)
        // When Edit mode is explicitly requested, always open editor regardless of mouse button
        ...
        // Image post-processing - use execDetached for reliability
    ...
    ScreencopyView {
        ...
        MouseArea {
            ...
            Row {
                ...
                visible: false  // Hide the bottom toolbar
                z: 9999
                anchors {
