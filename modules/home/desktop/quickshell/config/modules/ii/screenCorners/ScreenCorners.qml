...
Scope {
    ...
    component CornerPanelWindow: PanelWindow {
        ...
        margins {
            // Extend 2px off screen on all sides to capture edge pixels
            left: cornerPanelWindow.anchors.left ? -2 : 0
            right: cornerPanelWindow.anchors.right ? -2 : 0
            top: cornerPanelWindow.anchors.top ? -2 : 0
            bottom: cornerPanelWindow.anchors.bottom ? -2 : 0
        }
