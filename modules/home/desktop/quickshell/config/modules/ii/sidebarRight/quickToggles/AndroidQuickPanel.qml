...
AbstractQuickPanel {
    ...
    // Toggles
    readonly property list<string> availableToggleTypes: ["network", "bluetooth", "idleInhibitor", "nightLight", "darkMode", "gameMode", "colorPicker", "mic", "audio", "notifications", "powerProfile"]
