...
in
{
  ...
  xdg.configFile = {
    "waywall/init.lua".text = ''
      ...
      local config = {
          input = {
              ...
              repeat_rate = 40,
              repeat_delay = 300,
      		remaps = remaps_active and other_remaps or keyboard_remaps,
              sensitivity = 0.3077,
      ...
      local function ensure_rebind_text()
          if not rebind_text then
              rebind_text = waywall.text({
                  text = remaps_active and " " or remaps_text_config.text,
                  x = remaps_text_config.x,
                  y = remaps_text_config.y,
                  color = remaps_active and "#FFFFFF00" or "#FFFFFFFF",
      ...
      [toggle_remaps_key] = function()
          ...
          waywall.set_remaps(remaps_active and other_remaps or keyboard_remaps)
      	...
      	[open_chat_key] = function()
      	    print("CHAT KEYBIND PRESSED - calling chat1:open()")
      	    chat1:open()
      	    print("CHAT KEYBIND DONE")
      	end,
    ...
    "waywall/chat.lua".source = ./chat.lua;

    # fetch_emotes.lua - 7TV emote fetcher
    "waywall/fetch_emotes.lua".source = ./fetch_emotes.lua;

    # Third-party Lua libraries
    "waywall/dkjson.lua".source = ./dkjson.lua;
    "waywall/utf8.lua".source = ./utf8.lua;

    # Static images directory
    "waywall/images/measuring_overlay.png".source = ./images/measuring_overlay.png;
  };
